...
export default {
	...
	authInternal: (forwardedIP) => {
		return !forwardedIP || /10\.(21|17)/g.test(forwardedIP) || /208\.104\.68\.141/g.test(forwardedIP); // Is the request being forwared through a proxy, or is the proxy IP internal
	},
