...
const Nav = props => {
	...
	useEffect(() => {
		if (/(teamschedule|allschedule|schedule|dual\.html|tournamentsummary)/i.test(window.location)) {
			setSubExpanded("schedule");
		}
...
<div>
	...
	<nav className={ isMenuOpen ? "active" : "" }>
		...
		<div className="fixedScroll">
			...
			<>
			<li role="button" className="button" onClick={ () => setSubExpanded(previousExpanded => previousExpanded === "schedule" ? null : "schedule") } aria-label="Schedule">
				{/* Post */}
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
			...
			<li role="button" onClick={ () => window.location = "/portal/teamschedule.html" } className={`button sub ${ subExpanded === "schedule" ? "active" : "" }`} aria-label="Team Schedule">
				<span>Team</span>
			</li>

			<li role="button" onClick={ () => window.location = "/portal/allschedule.html" } className={`button sub ${ subExpanded === "schedule" ? "active" : "" }`} aria-label="All Events Schedule">
			...
			<li role="button" onClick={ () => window.location = "/portal/teamduplicate.html" } className={`button sub ${ subExpanded === "data" ? "active" : "" }`} aria-label="Team Search">
