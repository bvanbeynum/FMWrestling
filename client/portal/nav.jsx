...
<div>
	...
	<nav className={ isMenuOpen ? "active" : "" }>
		...
		<li onClick={ () => menuClick("roles") } className={`sub ${ subExpanded === "user" ? "active" : "" }`}>
			<span>Roles</span>
		</li>

		<li onClick={ () => menuClick("requests") } className={`sub ${ subExpanded === "user" ? "active" : "" }`}>
			<span>Requests</span>
		</li>
